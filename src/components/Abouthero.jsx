    ...
    <div className="about-hero-container">
      <div className="about-hero-grid">
        ...
        <div className="about-hero-content">
          <h2 className="about-hero-heading" style={{fontFamily:"Mier demi"}}>About Us</h2>
...
/>
        ...
        <div className="about-hero-content history">
          <h2 className="about-hero-heading" style={{fontFamily:"Mier demi"}}>Our Vision</h2>
          <p style={{textAlign: "justify"}}>
          ...
          <h2 className="about-hero-heading"  style={{fontFamily:"Mier demi"}}>Our Mission</h2>
          <p style={{textAlign: "justify"}}>
